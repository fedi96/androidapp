...
public class login_act extends AppCompatActivity {
    ...
    public void newact(View arg0) {
        Intent intent = new Intent(login_act.this, new_act.class);
    ...
    private class AsyncLogin extends AsyncTask<String, String, String> {
        ProgressDialog pdLoading = new ProgressDialog(login_act.this);
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equalsIgnoreCase("true")) {
                ...
                Intent intent = new Intent(login_act.this, generale.class);
                startActivity(intent);
                login_act.this.finish();
                ...
                Toast.makeText(login_act.this, "Invalid email or password", Toast.LENGTH_LONG).show();

            } else if (result.equalsIgnoreCase("exception") || result.equalsIgnoreCase("unsuccessful")) {

                Toast.makeText(login_act.this, "OOPs! Something went wrong. Connection Problem.", Toast.LENGTH_LONG).show();
